...
public class BeitragController {
    ...
    public String create(@ModelAttribute("beitrag") @Valid BeitragDTO beitrag, BindingResult bindingResult,
        ...
        return getString(beitrag, currentUser, beitragEntity);
    }
    ...
    public String bearbeiteBeitrag(@ModelAttribute("currentBeitrag") @Valid BeitragDTO beitrag, BindingResult bindingResult,
        ...
        return getString(beitrag, currentUser, dieserBeitrag);
    }

    private String getString(@Valid @ModelAttribute("currentBeitrag") BeitragDTO beitrag, @ModelAttribute("currentUser") User currentUser, Beitrag dieserBeitrag) {
